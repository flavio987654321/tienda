...
4. Dentro de "Configuración avanzada" están, agrupadas bajo 4 títulos (cada sección con su nombre real):
   ...
   - "Analytics y publicidad" — dos campos opcionales, cada uno con su propia ayuda abajo: "Google Analytics — ID de medición" (formato "G-XXXXXXXXXX", se consigue en analytics.google.com) y "Facebook Pixel — ID" (solo números, se consigue en business.facebook.com → Administrador de eventos). Sirven para que el dueño vea de dónde viene su tráfico (Analytics) y para que sus anuncios de Instagram/Facebook rindan mejor (Pixel). Son gratis y 100% opcionales — cada dueño crea su propia cuenta, no hay nada centralizado de TiendaApps. Si el campo tiene un formato inválido, aparece un aviso en rojo explicando qué falta corregir.
