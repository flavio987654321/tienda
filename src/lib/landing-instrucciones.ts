...
7. Links del pie: poné estos cinco, con href="#" y exactamente este texto: "Términos y condiciones", "Política de privacidad", "Política de reembolso", "Botón de arrepentimiento" (es obligatorio por ley en Argentina) y "Contacto"; sumá "Instagram" u otras redes si querés. Los legales los conecta TiendaApps solo; los demás los completo yo desde el panel. Los links internos a otra sección (href="#seccion") SÍ funcionan y bajan suave, así que podés usarlos; sólo acordate de que el botón que cobra es data-tienda="comprar", no un link a la sección de la oferta.
