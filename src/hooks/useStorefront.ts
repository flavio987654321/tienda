...
const DEMO_PRODUCTS_AUTOS: StorefrontProduct[] = [
  ...
  { id: "auto-9", name: "Toyota Hilux SRX", price: 47000000, comparePrice: null, category: "Pickups", description: "La pickup más vendida de Argentina. Motor diesel 2.8, full equipo, techo solar.", images: ["https://images.unsplash.com/photo-1563720223809-b2a47d82c4e4?auto=format&fit=crop&w=800&q=75","https://images.unsplash.com/photo-1544636331-e26879cd4d9b?auto=format&fit=crop&w=800&q=75"], imageItems: [{ url: "https://images.unsplash.com/photo-1563720223809-b2a47d82c4e4?auto=format&fit=crop&w=800&q=75" },{ url: "https://images.unsplash.com/photo-1544636331-e26879cd4d9b?auto=format&fit=crop&w=800&q=75" }], sizes: [], colors: [], variants: [], reelUrls: [], precioMayorista: null, cantMinMayorista: null, gender: "unisex", badge: "DESTACADO", attributes: [{ key: "Marca", value: "Toyota" }, { key: "Modelo", value: "Hilux" }, { key: "Versión", value: "SRX" }, { key: "Año", value: "2023" }, { key: "Km", value: "18.000" }, { key: "Motor", value: "2.8 TDI" }, { key: "Transmisión", value: "Automática" }, { key: "Combustible", value: "Diesel" }, { key: "Tracción", value: "4x4" }, { key: "Carrocería", value: "Pickup" }, { key: "Color", value: "Blanco Perla" }, { key: "Puertas", value: "4" }] },
  { id: "auto-10", name: "Peugeot 208 GT", price: 18500000, comparePrice: 21000000, category: "Sedanes", description: "Hatchback premium con interior i-Cockpit. Motor PureTech 130 HP turbo.", images: ["https://images.unsplash.com/photo-1590508279593-c5f85efd5f22?auto=format&fit=crop&w=800&q=75","https://images.unsplash.com/photo-1541899481282-d53bffe3c35d?auto=format&fit=crop&w=800&q=75"], imageItems: [{ url: "https://images.unsplash.com/photo-1590508279593-c5f85efd5f22?auto=format&fit=crop&w=800&q=75" },{ url: "https://images.unsplash.com/photo-1541899481282-d53bffe3c35d?auto=format&fit=crop&w=800&q=75" }], sizes: [], colors: [], variants: [], reelUrls: [], precioMayorista: null, cantMinMayorista: null, gender: "unisex", badge: "OPORTUNIDAD", attributes: [{ key: "Marca", value: "Peugeot" }, { key: "Modelo", value: "208" }, { key: "Versión", value: "GT" }, { key: "Año", value: "2022" }, { key: "Km", value: "42.000" }, { key: "Motor", value: "1.2 PureTech" }, { key: "Transmisión", value: "Automática" }, { key: "Combustible", value: "Nafta" }, { key: "Tracción", value: "4x2" }, { key: "Carrocería", value: "Hatchback" }, { key: "Color", value: "Rojo" }, { key: "Puertas", value: "5" }] },
