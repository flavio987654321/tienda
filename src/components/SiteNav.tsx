...
import { LINKS_PUBLICOS, type SiteNavKey } from "@/lib/nav-publico";

// Nav público de las pantallas internas. Antes cada página pública se copiaba
// el nav a mano (home, contacto, precios, seguimiento, quienes-somos) y las
// copias se fueron desincronizando: quienes-somos apuntaba a /tiendas mientras
// el resto apuntaba al ancla #tiendas, y contacto/seguimiento nunca mostraron
// la sesión iniciada. Un solo componente evita que vuelva a pasar.
//
// La home es la única que sigue con nav propio, porque el suyo arranca
// transparente sobre el hero y abre un cajón lateral en vez de este panel. Lo
// que comparte con éste es el listado de links (`@/lib/nav-publico`), que es lo
// que de verdad se desincronizaba.
