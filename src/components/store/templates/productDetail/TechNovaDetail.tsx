...
export default function TechNovaDetail({ view }: { view: ProductDetailViewProps }) {
  ...
  return (
    <div style={{ minHeight: "100vh", background: theme.pageBg, fontFamily: theme.font, color: theme.text }}>
      ...
      <footer style={{ background: "#0f0f1a", padding: "28px 24px", textAlign: "center" }}>
      ...
      {toastMsg && (
        <div style={{ position: "fixed", bottom: 24, left: "50%", transform: "translateX(-50%)", background: "#0f0f1a", color: "#fff", fontSize: 13, padding: "10px 18px", borderRadius: 100, zIndex: 60 }}>
          {toastMsg}
        </div>
      )}
    </div>
